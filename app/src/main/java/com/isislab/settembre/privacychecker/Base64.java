...
public class Base64 {
    ...
    static class AnonymousClass1 extends ObjectInputStream {
        ...
        AnonymousClass1(java.io.InputStream $anonymous0, ClassLoader classLoader) throws StreamCorruptedException, IOException {
            super($anonymous0);
    ...
    public static String encodeBytes(byte[] source) {                           //CHIAMATO DA FileSHA1.java
        String encoded = null;
        try {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws IOException {
        ...
        if (source == null) {
            ...
            ByteArrayOutputStream baos = null;                                      //Questa classe implementa un flusso di output in cui i dati vengono scritti in un array di byte
            GZIPOutputStream gzos = null;                                           //Questa classe implementa un filtro di flusso per la scrittura di dati compressi nel formato di file GZIP.
            ...
            try {
                ...
                try {
                    GZIPOutputStream gZIPOutputStream = new GZIPOutputStream(b64os);        //Crea un nuovo flusso di output con una dimensione di buffer predefinita.
                    try {
                        gZIPOutputStream.write(source, off, len);                       //Scrive array di byte al flusso di output compresso. Questo metodo blocca fino a quando non vengono scritti tutti i byte.
            ...
            System.arraycopy(outBuff, 0, finalOut, 0, e12);             //Copia un array da una posizione specifica all'altra a partire dalla posizione specificata, alla posizione specificata dell'array di destinazione
