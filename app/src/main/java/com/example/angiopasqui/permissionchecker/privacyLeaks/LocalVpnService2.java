...
public class LocalVpnService2 extends VpnService implements Handler.Callback,DnsPacketProxy.EventLoop {
    ...
    private static LocalVpnService2 instance;
    ...
    public void onCreate() {
        ...
        if(GlobalState.VPN_ENABLED) {
            ...
            pendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, LocalVpnService2.class), PendingIntent.FLAG_UPDATE_CURRENT);
        }
    ...
    private void runVpn() throws InterruptedException, ErrnoException, IOException, VpnNetworkException, PcapNativeException, TimeoutException, NotOpenException {
        Log.d("DEBUG","metodo runVpn LocalVpnService2");
    ...
    private ParcelFileDescriptor configure()throws VpnNetworkException{
        Log.d("DEBUG","metodo configure LocalVpnService2");
    ...
    private void readPacketFromDevice(FileInputStream inputStream, byte[] packet) throws VpnNetworkException, SocketException, PcapNativeException, NotOpenException, EOFException, TimeoutException {
        ...
        if (stats != null) {
            ...
            if (mySortedMap != null && !mySortedMap.isEmpty()) {
                ...
                Log.e("topActivity: ","NOME APPPPP" + topActivity);
            }
        }
        */
        ...
        if (usageStatsManager != null)
        {
            ...
            if (queryEvents != null)
            {
                ...
                try {
                    ...
                    foregroundAppPackageInfo = pm.getPackageInfo(packageName, 0);
                    if(foregroundAppPackageInfo.applicationInfo != null) {
                        System.out.println("NOME APP " + foregroundAppPackageInfo.applicationInfo.loadLabel(pm).toString());
                    }
                } catch (PackageManager.NameNotFoundException e) {
...
*/
    ...
    public static LocalVpnService2 getInstance() {
